...
import pandas as pd
import numpy as np
from omni.base import BaseIDTransformer
from sklearn.base import TransformerMixin, BaseEstimator
from data.extracts import irregular_cols
from external.evaluate_sepsis_score import compute_prediction_utility
...
class CreateDataframe(TransformerMixin, BaseEstimator):
    ...
    def transform(self, location):
        ...
        if self.save is not False:
            ...
            save_pickle(df_values, DATA_DIR + '/preprocessed/from_raw/df.pickle')
...
class DerivedFeatures(TransformerMixin, BaseEstimator):
    ...
    def transform(self, df):
        ...
        df['PaO2/FiO2'] = 713 - (df['PaCO2'].values/df['FiO2'].values * 0.8)
